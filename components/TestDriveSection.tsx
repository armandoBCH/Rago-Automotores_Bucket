...
import { SteeringWheelIcon, ArrowRightIcon } from '../constants';
...
const TestDriveSection: React.FC<TestDriveSectionProps> = ({ vehicle }) => {
    ...
    return (
        <section className="bg-slate-50 dark:bg-gray-900/50 rounded-2xl shadow-subtle dark:shadow-subtle-dark border border-gray-200 dark:border-gray-800">
            ...
            <div className="p-6">
                <p className="mb-4 text-base text-gray-600 dark:text-gray-300">
                    Completá el formulario para coordinar una prueba de manejo.
                </p>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="preferredDate" value={preferredDate} onChange={(e) => setPreferredDate(e.target.value)} placeholder="Indicá tu preferencia de día y horario" required rows={2} className="form-input" />
                    </div>
